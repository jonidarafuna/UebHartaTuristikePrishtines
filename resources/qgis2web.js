...
map.getView().fit([7512924.597753, 4722995.616776, 7513803.014419, 4723428.871985], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ueb harta turistike e Prishtinës</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_PikatTuristiketPrishtins_10,
    colName: 'Emri',
    zoom: 10,
    collapsed: true,
    map: map
